...
{related_cards(page)}
    ...
    <section class="section-block" id="lead">
      <div class="wrap wrap--wide" style="display:grid;gap:1.25rem;">
        ...
        <div class="media-card">
          ...
          <div class="form-actions">
            <a class="btn btn--gold" href="https://www.youtube.com/watch?v=vUQhJJHAJbI" target="_blank" rel="noopener noreferrer">Смотреть видео</a>
            <a class="btn btn--ghost" href="https://www.youtube.com/@AngelGranitfpv" target="_blank" rel="noopener noreferrer">Канал YouTube</a>
  ...
  <footer class="footer">
    ...
    <ul class="footer-links">
      ...
      <li><a href="https://www.youtube.com/@AngelGranitfpv" target="_blank" rel="noopener noreferrer">YouTube</a></li>
    </ul>
  </footer>
